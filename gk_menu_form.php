...
require_once "scripts/database_connection.php";//instantiate the mysqli object
require_once "scripts/gk_db_util.php";


//Get values stored in the database to keep the values up to date
$headers = gk_db_util::get_headers($mysqli);
$breakfast = gk_db_util::get_breakfast($mysqli);
$salads = gk_db_util::get_salads($mysqli);
$cold_sands = gk_db_util::get_cold_sands($mysqli);
$wraps = gk_db_util::get_wraps($mysqli);
$sides = gk_db_util::get_sides($mysqli);
$hot_sands = gk_db_util::get_hot_sands($mysqli);
$veggies = gk_db_util::get_veggies($mysqli);
$speicals = gk_db_util::get_specials($mysqli);
